...
type HomeTopNavigationProps = Record<string, never>;
      ...
      <div className="flex h-12 flex-1 items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Button
            variant="ghost"
            size="sm"
            className="h-7 gap-1 rounded px-2 text-[13px] font-light text-white hover:bg-white/10"
          >
          ...
          <SignedOut>
            <SignInButton>
              <Button
                variant="ghost"
                size="sm"
                className="text-[13px] text-white hover:bg-white/10"
              >
                Sign in
              </Button>
            </SignInButton>
...
export function HomeTopNavigation({}: HomeTopNavigationProps) {
  return (
    <header className="border-b border-gray-200 bg-white">
      <div className="flex h-12 items-center justify-between px-4">
        ...
        <div className="flex h-8 w-[400px] items-center gap-2 rounded-lg border bg-gray-50 px-3">
          ...
          />
          <div className="flex items-center gap-1 rounded border-l pl-2 text-xs text-gray-500">
